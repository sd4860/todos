  ...
  <div id="app">
    <section class="todoapp">
      ...
      <footer class="footer" v-show="hasTodo">
        ...
        <ul class="filters">
          <li>
            <a href="#" @click="filter = 'all'" :class="{selected: filter === 'all'}">Toutes</a>
          </li>
          <li>
            <a href="#" @click="filter = 'todo'" :class="{selected: filter === 'todo'}">A faire</a>
          </li>
          <li>
            <a href="#" @click="filter = 'done'" :class="{selected: filter === 'done'}">Faites</a>
          </li>
        </ul>
        <button class="clear-completed" v-show="completed" @click="deleteCompleted()"><!-- v-if ne se voit pas dans html -->
